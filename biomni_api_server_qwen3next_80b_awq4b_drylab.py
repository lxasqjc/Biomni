#!/usr/bin/env python3
"""
FastAPI server for Biomni agent — Qwen3-Next-80B-A3B-Instruct-AWQ-4bit on alan drylab.
Model/endpoint can be configured via environment variables:
  BIOMNI_MODEL       - model name (default: Qwen3-Next-80B-A3B-Instruct-AWQ-4bit)
  BIOMNI_BASE_URL    - base URL (default: http://alan:5401/v1)
...
# ---------------------------------------------------------------------------
_DEFAULT_MODEL    = "Qwen3-Next-80B-A3B-Instruct-AWQ-4bit"
_DEFAULT_BASE_URL = "http://alan:5401/v1"
