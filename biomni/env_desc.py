...
data_lake_dict = {
    ...
    "BindingDB_All_202409.parquet": "Measured binding affinities between proteins and small molecules for drug discovery.",
    ...
    "ddinter_alimentary_tract_metabolism.parquet": "Drug-drug interactions for alimentary tract and metabolism drugs from DDInter 2.0 database.",
    "ddinter_antineoplastic.parquet": "Drug-drug interactions for antineoplastic and immunomodulating agents from DDInter 2.0 database.",
    "ddinter_antiparasitic.parquet": "Drug-drug interactions for antiparasitic products from DDInter 2.0 database.",
    "ddinter_blood_organs.parquet": "Drug-drug interactions for blood and blood forming organs drugs from DDInter 2.0 database.",
    "ddinter_dermatological.parquet": "Drug-drug interactions for dermatological drugs from DDInter 2.0 database.",
    "ddinter_hormonal.parquet": "Drug-drug interactions for systemic hormonal preparations from DDInter 2.0 database.",
    "ddinter_respiratory.parquet": "Drug-drug interactions for respiratory system drugs from DDInter 2.0 database.",
    "ddinter_various.parquet": "Drug-drug interactions for various drugs from DDInter 2.0 database.",
    ...
    "evebio_assay_table.parquet": "Assay metadata with one row per assay from EveBio pharmome mapping.",
    "evebio_bundle_table.parquet": "Target subfamily bundles used for screening-to-profiling progression.",
    "evebio_compound_table.parquet": "Compound metadata with common identifiers from EveBio screening.",
    "evebio_control_table.parquet": "Control datapoints for all screening and profiling plates.",
    "evebio_detailed_result_table.parquet": "Expanded results on evebio_summary_result_table with curve fit parameters and phase categories.",
    "evebio_observed_points_table.parquet": "Raw observed datapoints from all screening and profiling experiments.",
    "evebio_summary_result_table.parquet": "Succinct summary of results for each assay-compound combination.",
    "evebio_target_table.parquet": "Target metadata with common identifiers from EveBio screening.",
