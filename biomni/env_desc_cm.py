...
data_lake_dict = {
    ...
    # "BindingDB_All_202409.parquet": "Measured binding affinities between proteins and small molecules for drug discovery.",  # Requires commercial license
    ...
    "DepMap_CRISPRGeneDependency.parquet": "Gene dependency probability estimates for cancer cell lines, including all DepMap models.",
    "DepMap_CRISPRGeneEffect.parquet": "Genome-wide CRISPR gene effect estimates for cancer cell lines, including all DepMap models.",
    "DepMap_Model.parquet": "Metadata describing all cancer models/cell lines which are referenced by a dataset contained within the DepMap portal.",
    "DepMap_OmicsExpressionProteinCodingGenesTPMLogp1.parquet": "Gene expression in TPMs for cancer cell lines, including all DepMap models.",
    # "ddinter_alimentary_tract_metabolism.parquet": "Drug-drug interactions for alimentary tract and metabolism drugs from DDInter 2.0 database.",  # CC BY-NC-SA 4.0 - Non-commercial only
    # "ddinter_antineoplastic.parquet": "Drug-drug interactions for antineoplastic and immunomodulating agents from DDInter 2.0 database.",  # CC BY-NC-SA 4.0 - Non-commercial only
    # "ddinter_antiparasitic.parquet": "Drug-drug interactions for antiparasitic products from DDInter 2.0 database.",  # CC BY-NC-SA 4.0 - Non-commercial only
    # "ddinter_blood_organs.parquet": "Drug-drug interactions for blood and blood forming organs drugs from DDInter 2.0 database.",  # CC BY-NC-SA 4.0 - Non-commercial only
    # "ddinter_dermatological.parquet": "Drug-drug interactions for dermatological drugs from DDInter 2.0 database.",  # CC BY-NC-SA 4.0 - Non-commercial only
    # "ddinter_hormonal.parquet": "Drug-drug interactions for systemic hormonal preparations from DDInter 2.0 database.",  # CC BY-NC-SA 4.0 - Non-commercial only
    # "ddinter_respiratory.parquet": "Drug-drug interactions for respiratory system drugs from DDInter 2.0 database.",  # CC BY-NC-SA 4.0 - Non-commercial only
    # "ddinter_various.parquet": "Drug-drug interactions for various drugs from DDInter 2.0 database.",  # CC BY-NC-SA 4.0 - Non-commercial only
    ...
    # "evebio_assay_table.parquet": "Assay metadata with one row per assay from EveBio pharmome mapping.",  # Proprietary - Requires permission
    # "evebio_bundle_table.parquet": "Target subfamily bundles used for screening-to-profiling progression.",  # Proprietary - Requires permission
    # "evebio_compound_table.parquet": "Compound metadata with common identifiers from EveBio screening.",  # Proprietary - Requires permission
    # "evebio_control_table.parquet": "Control datapoints for all screening and profiling plates.",  # Proprietary - Requires permission
    # "evebio_detailed_result_table.parquet": "Expanded results on evebio_summary_result_table with curve fit parameters and phase categories.",  # Proprietary - Requires permission
    # "evebio_observed_points_table.parquet": "Raw observed datapoints from all screening and profiling experiments.",  # Proprietary - Requires permission
    # "evebio_summary_result_table.parquet": "Succinct summary of results for each assay-compound combination.",  # Proprietary - Requires permission
    # "evebio_target_table.parquet": "Target metadata with common identifiers from EveBio screening.",  # Proprietary - Requires permission
    "genebass_missense_LC_filtered.parquet": "Filtered missense variants from GeneBass.",
    "genebass_pLoF_filtered.pkl": "Predicted loss-of-function variants from GeneBass.",
    "genebass_synonymous_filtered.parquet": "Filtered synonymous variants from GeneBass.",
    ...
    "gwas_catalog.parquet": "Genome-wide association studies (GWAS) results.",
    "hp.obo": "Official HPO release in obographs format",
    "kg.parquet": "Precision medicine knowledge graph with 17,080 diseases and 4+ million relationships across biological scales.",
    ...
    "proteinatlas.parquet": "Protein expression data from Human Protein Atlas.",
    ...
    "sgRNA_KO_SP_mouse.parquet": "sgRNA knockout data for mouse.",
    "sgRNA_KO_SP_human.parquet": "sgRNA knockout data for human.",
